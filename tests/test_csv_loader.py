...
CSV files are produced by ``shodan convert <file.json.gz> csv``.
Columns (as written by shodan's CsvConverter):
...
from globe_3d.csv_loader import _severity_from_cve_list, load_csv
